...
class Base {
	...
	public function script_params($params)
	{
		...
		if( isset($params['theme_js_params']['embed_responsive']['elements']) ){
			$params['theme_js_params']['embed_responsive']['elements'][] = '.rey-wcPanel--description iframe[src*="youtu"]';
			$params['theme_js_params']['embed_responsive']['elements'][] = '.woocommerce-Tabs-panel--description iframe[src*="youtu"]';
