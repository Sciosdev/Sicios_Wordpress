	...
	function add_excerpt_toggle( $excerpt ){
		...
		// keep tags
			...
			if( $full_content ):
				...
				$excerpt .= '</div>';
				$excerpt .= '<button class="btn btn-line-active" aria-label="Toggle"><span data-read-more="'. esc_html_x('Read more', 'Toggling the product excerpt.', 'rey-core') .'" data-read-less="'. esc_html_x('Less', 'Toggling the product excerpt.', 'rey-core') .'"></span></button>';
			endif;
		}
