...
class BufferManager
{
    ...
    public static function should_buffer( $doing_tests = false )
    {
        ...
        if ( null === $do_buffering || $doing_tests ) {
            ...
            if ( false === $_noptimize ) {
                $_qs_showstoppers = [
					'no_cache', 'no_optimize', 'tve', 'elementor-preview', 'fl_builder', 'vc_action', 'et_fb', 'bt-beaverbuildertheme', 'ct_builder', 'fb-edit', 'siteorigin_panels_live_editor', 'preview', 'nowprocket', 'wc-api'
				];
