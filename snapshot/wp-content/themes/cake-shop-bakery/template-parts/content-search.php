...
<div class="<?php if(get_theme_mod('cake_shop_bakery_blog_post_columns','Two') == 'Two'){?>col-lg-6 col-md-6<?php } elseif(get_theme_mod('cake_shop_bakery_blog_post_columns','Two') == 'Three'){?>col-lg-4 col-md-6<?php }?>">
	<article id="post-<?php the_ID(); ?>" <?php post_class('article-box'); ?>>
        <?php if ( has_post_thumbnail() ) { ?><?php cake_shop_bakery_post_thumbnail(); ?><?php }?>
