	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
				...
				'default'     => [],
				'condition' => [
					'query_type!' => ['manual-selection', 'recently-viewed', 'recently-purchased', 'current_query', 'current_query_original', 'related', 'cross-sells', 'up-sells', 'acf'],
				],
            ]
		);
				...
				'conditions' => [
					...
					'terms' => [
						[
							'name' => 'query_type',
							'operator' => '!in',
							'value' => ['manual-selection', 'recently-viewed', 'recently-purchased', 'current_query', 'current_query_original', 'related', 'cross-sells', 'up-sells', 'acf'],
						],
						[
							'name' => 'categories',
							'operator' => '!=',
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'query_type!' => ['manual-selection', 'recent', 'top', 'best-selling', 'recently-viewed', 'recently-purchased', 'related', 'cross-sells', 'up-sells', 'current_query_original', 'acf'],
				],
				'separator'   => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator'   => 'before',
				'condition' => [
					'query_type!' => ['manual-selection', 'current_query_original', 'acf'],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'query_type!' => ['manual-selection', 'recently-viewed', 'related', 'cross-sells', 'up-sells', 'current_query_original', 'acf'],
				],
				'separator'   => 'before',
				'wpml' => false,
			]
